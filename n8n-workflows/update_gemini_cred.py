...
def main():
    ...
    s = login()
    # n8n credential type for Google Gemini is usually 'googleGeminiChatApi' or similar
    # In n8n-nodes-base, it's 'googleGeminiChatApi'
    create_credential(s, "NEXUS Gemini", "googleGeminiChatApi", {"apiKey": GEMINI_KEY})
