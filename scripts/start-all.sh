...
if $include_app; then
  services="nexus-app postgres postgres-ai redis traefik vaultwarden prometheus loki grafana wireguard telegram-notify uptime-kuma n8n node_exporter postgres_exporter redis_exporter"
else
  services="postgres postgres-ai redis traefik vaultwarden prometheus loki grafana wireguard telegram-notify uptime-kuma n8n node_exporter postgres_exporter redis_exporter"
fi
